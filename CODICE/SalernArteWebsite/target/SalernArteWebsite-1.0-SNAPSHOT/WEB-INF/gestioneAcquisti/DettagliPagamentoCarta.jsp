...
<jsp:include page="../Header.jsp">
  <jsp:param name="pageTitle" value="Finalizza pagamento"/>
  <jsp:param name="stylesheet" value="CSS/DettagliPagamentoCarta.css"/>
</jsp:include>
<div class="tips">
...
<div class="containerPayment">
  ...
  <div class="col2">
    ...
    <label>Nome proprietario carta</label>
  ...
  $(function(){
    ...
    $(".number").keyup(function(event){
      ...
      if(selected_card != -1){
        ...
        html.setAttribute("style", "--card-color: #632020");
